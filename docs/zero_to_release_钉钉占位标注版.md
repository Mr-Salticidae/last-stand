...
**说明：本版正文中每个 🔴 标识处需手动上传对应图片。**标识内已注明该图的说明与源文件路径（相对仓库根 `e:\last-stand`）。文末附完整图片上传对照表。

## 一、成品展示

🔴【图1 · LAST STAND ｜ 源文件：banner.png】

🔴【图2 · 主菜单 ｜ 源文件：assets/screenshots/上传itch/01_menu.png】

🔴【图3 · 战斗 ｜ 源文件：assets/screenshots/combat_v0.7.png】

🔴【图4 · 升级三选一 ｜ 源文件：assets/screenshots/上传itch/04_update.png】
...
🔴【图5 · Godot 编辑器工作界面 ｜ 源文件：assets/screenshots/godot展示.png】
...
🔴【图6 · Autoload 全局单例面板 ｜ 源文件：assets/screenshots/tutorial/s1_autoload.png】
...
🔴【图7 · 文件系统目录结构 ｜ 源文件：assets/screenshots/tutorial/s2_filesystem.png】
...
🔴【图8 · 检查器中的 @export 分组 ｜ 源文件：assets/screenshots/tutorial/s3_inspector_export.png】
...
🔴【图9 · 导出对话框 ｜ 源文件：assets/screenshots/tutorial/s4_export_dialog.png】
...
🔴【图10 · GitHub Release 页面 ｜ 源文件：assets/screenshots/tutorial/s5_github_release.png】

同一批内容再发一份到 itch.io，这边面向玩家、带评论区：

🔴【图11 · itch.io 上架页 ｜ 源文件：assets/screenshots/itch上架首页.png】
...
🔴【图12 · hitbox 运行时可视化 ｜ 源文件：assets/screenshots/碰撞.png】
